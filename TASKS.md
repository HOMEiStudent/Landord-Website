...
- [ ] **T03** — Update `<title>` to: `Student Landlord Property Management Software (UK) – Renters' Rights Act Ready | HOMEi PM`. Verify visible portion before the pipe is 55–65 characters.
